...
public class MarkerCluster {
    ...
    public void cluster() {
        ...
        if (list == null || list.size() == 0) {
            Log.w("cluser", "cluster with no data at all");
            return;
        }
    ...
    private List<Index> getIndexByLatLon(double lat, double lon) {
    ...
    public int getLevelByArea(
        ...
        //Log.d("cluser", "getLevelByArea, level: " + level);
        return level;
    }

    private List<MarkerInfo> getMarkerListByLevel(int level) {
    ...
    private MarkerInfo clusterData(IndexTree<Index, MarkerInfo> index_tree) {
        ...
        if (childCount == 0) {
            ...
            System.out.println("-------->");
            System.out.println("data.getMarker()"+data.getMarker());
            System.out.println("data.getMarkerCount()"+data.getMarkerCount());
            System.out.println("data.getMarkerList()"+data.getMarkerList());
            return data;
        }
    }
